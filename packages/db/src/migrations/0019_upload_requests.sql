...
CREATE INDEX IF NOT EXISTS "upload_requests_status_idx"
  ON "upload_requests" ("status", "created_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "upload_requests_requester_idx"
...
-- in the table.
CREATE INDEX IF NOT EXISTS "upload_requests_filled_at_idx"
  ON "upload_requests" ("filled_at")
  WHERE "status" = 'filled' AND "filled_at" IS NOT NULL;
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "upload_request_fill_attempts" (
  "id"           text PRIMARY KEY,
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "upload_request_fill_attempts_request_user_idx"
  ON "upload_request_fill_attempts" ("request_id", "user_id");
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "upload_request_comments" (
  "id"             text PRIMARY KEY,
  "request_id"     text NOT NULL REFERENCES "upload_requests"("id") ON DELETE CASCADE,
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "upload_request_comments_request_idx"
