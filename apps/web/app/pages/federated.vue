...
.fb-count { display: inline-flex; align-items: center; gap: 0.35rem; font-family: var(--font-mono); font-size: 0.6875rem; color: #7dd3fc; background: rgba(56, 189, 248, 0.1); border: 1px solid rgba(56, 189, 248, 0.3); padding: 0.2rem 0.55rem; border-radius: var(--radius-sm); }
...
.origin { display: inline-flex; align-items: center; gap: 0.3rem; font-size: 0.6563rem; font-family: var(--font-mono); color: #7dd3fc; background: rgba(56, 189, 248, 0.1); border: 1px solid rgba(56, 189, 248, 0.3); padding: 0.05rem 0.4rem; border-radius: var(--radius-sm); }
...
.src-peer { display: inline-flex; align-items: center; gap: 0.3rem; color: #7dd3fc; font-family: var(--font-mono); white-space: nowrap; }
.src-meta { display: inline-flex; align-items: center; gap: 0.45rem; font-family: var(--font-mono); font-size: 0.6563rem; color: rgb(var(--fg-faint)); }
...
.num { font-family: var(--font-mono); font-size: 0.7813rem; text-align: right; color: rgb(var(--fg-muted)); }
