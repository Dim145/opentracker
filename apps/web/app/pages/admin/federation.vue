        ...
        <section class="card">
          ...
          <div class="card-body">
            <template v-if="cfg?.provisioned">
              ...
              <button class="btn btn-primary fed-save" :disabled="busy.identity" @click="saveIdentity">
      ...
      <section class="card">
        <div class="card-body">
          <form class="fed-add-form" @submit.prevent="submitAdd">
            ...
            <button class="btn btn-primary" :disabled="busy.add || !addUrl">
...
.fed-intro { font-size: 0.8125rem; color: rgb(var(--fg-muted)); line-height: 1.55; max-width: 70ch; display: flex; align-items: center; gap: 0.6rem; flex-wrap: wrap; }
.fed-owner { display: inline-flex; align-items: center; gap: 0.3rem; font-size: 0.6875rem; font-weight: 600; color: var(--gold, rgb(var(--accent-warm))); border: 1px solid color-mix(in srgb, var(--gold, rgb(var(--accent-warm))) 30%, transparent); background: color-mix(in srgb, var(--gold, rgb(var(--accent-warm))) 10%, transparent); padding: 0.15rem 0.5rem; border-radius: var(--radius-pill); }

.fed-flash { display: flex; align-items: center; gap: 0.5rem; padding: 0.65rem 0.9rem; border-radius: var(--radius-md); font-size: 0.8125rem; border: 1px solid; }
...
.fed-master-ring { width: 42px; height: 42px; border-radius: 50%; display: grid; place-items: center; background: rgb(var(--bg-elevated)); color: rgb(var(--fg-subtle)); font-size: 1.3rem; flex-shrink: 0; }
.fed-master.is-on .fed-master-ring { background: rgba(34, 197, 94, 0.12); color: rgb(var(--online)); }
.fed-master-txt { flex: 1; min-width: 0; }
.fed-master-h { display: flex; align-items: center; gap: 0.5rem; font-size: 1rem; font-weight: 600; color: rgb(var(--fg-strong)); }
.fed-oneway {
  display: flex;
...
.fed-master-txt p { font-size: 0.7813rem; color: rgb(var(--fg-muted)); margin-top: 0.2rem; }
...
.scope-t { font-weight: 600; font-size: 0.8125rem; color: rgb(var(--fg-default)); display: flex; align-items: center; gap: 0.4rem; }
...
.fed-empty { text-align: center; padding: 2rem; color: rgb(var(--fg-subtle)); border: 1px dashed rgb(var(--line-default)); border-radius: var(--radius-md); display: flex; flex-direction: column; align-items: center; gap: 0.5rem; font-size: 0.8125rem; }
...
.fed-dot.on { background: rgb(var(--online)); }
.fed-dot.warn { background: rgb(var(--warning)); }
.fed-dot.off { background: rgb(var(--danger)); }
.fed-dot.idle { background: rgb(var(--fg-subtle)); }

/* small action buttons */
.fbtn { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.4rem 0.65rem; border-radius: var(--radius-sm); font-size: 0.75rem; font-weight: 600; border: 1px solid rgb(var(--line-default)); background: rgb(var(--bg-elevated)); color: rgb(var(--fg-default)); transition: all var(--dur-2) ease; }
