...
.fed-id dt { color: rgb(var(--fg-subtle)); text-transform: uppercase; font-size: 10.5px; font-weight: 600; letter-spacing: 0.05em; }
...
.fed-field label { display: block; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: rgb(var(--fg-subtle)); margin-bottom: 0.3rem; }
...
.scope-d { font-size: 11.5px; color: rgb(var(--fg-subtle)); margin-top: 1px; }
...
.kpi-n { font-size: 24px; font-weight: 700; color: rgb(var(--fg-strong)); font-variant-numeric: tabular-nums; line-height: 1; }
.kpi-l { display: block; font-size: 10.5px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: rgb(var(--fg-subtle)); margin-top: 0.3rem; }
...
.peer-url { font-family: var(--font-mono, monospace); font-size: 11px; color: rgb(var(--fg-subtle)); margin-top: 0.15rem; word-break: break-all; }
...
.fed-sub { display: block; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: rgb(var(--fg-subtle)); }
