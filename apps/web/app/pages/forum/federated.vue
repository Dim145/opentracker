...
.ff-c { font-family: var(--font-mono, monospace); font-size: 11px; color: rgb(var(--fg-subtle)); background: rgb(var(--bg-elevated)); border: 1px solid rgb(var(--line-default)); border-radius: var(--radius-pill); padding: 0.05rem 0.45rem; margin-left: 0.2rem; }
...
.ff-cat { font-size: 10.5px; color: var(--gold, rgb(var(--accent-warm))); background: rgb(var(--accent-warm) / 0.1); border: 1px solid rgb(var(--accent-warm) / 0.3); border-radius: var(--radius-pill); padding: 0.05rem 0.45rem; }
