        ...
        >
          ...
          <div class="mb-4">
            ...
            <input
              ...
              type="password"
              class="w-full bg-bg-tertiary border border-border-field rounded px-3 py-2 text-sm focus:border-error transition-colors"
        ...
        >
          ...
          <div class="mb-4">
            ...
            <input
              ...
              type="password"
              class="w-full bg-bg-tertiary border border-border-field rounded px-3 py-2 text-sm focus:border-success transition-colors"
              :placeholder="$t('admin.panic.panicPasswordPlaceholder')"
